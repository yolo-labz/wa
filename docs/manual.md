...
Crash-safe: uses a `.migrating` write-ahead marker and a single `os.Rename` pivot. See `specs/008-multi-profile/contracts/migration.md` for the 25-step sequence.
...
See the canonical table in [`../CLAUDE.md` §Filesystem layout](../CLAUDE.md) and the per-feature breakdown in [`../specs/008-multi-profile/contracts/profile-paths.md`](../specs/008-multi-profile/contracts/profile-paths.md).
...
- [`CLAUDE.md`](../CLAUDE.md) — architectural blueprint + port interfaces
- [`SECURITY.md`](../SECURITY.md) — full threat model
- [`CONTRIBUTING.md`](../CONTRIBUTING.md) — speckit workflow + commit style
- [`specs/008-multi-profile/`](../specs/008-multi-profile/) — the multi-profile spec + contracts + research
- [`specs/008-multi-profile/benchmarks.txt`](../specs/008-multi-profile/benchmarks.txt) — performance baselines
