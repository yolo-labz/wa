{
  ...
  outputs = {
    ...
    perSystem = flake-utils.lib.eachDefaultSystem (system: let
      ...
      # Go 1.26.5 override. nixpkgs (incl. master as of 19/05/2026)
      # ships only 1.26.2; go.mod requires 1.26.5 to pull the stdlib
      # patches for GO-2026-5856 (crypto/tls — Encrypted Client Hello
      # privacy leak) and GO-2026-4970 (os — root escape via symlink +
      # trailing slash), both flagged reachable by govulncheck on
      # 17/07/2026, on top of GO-2026-5039 (net/textproto) and
      # GO-2026-5037 (crypto/x509) from the 20/06 audit and the earlier
