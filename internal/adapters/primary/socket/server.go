...
// The method set is in server.go (lifecycle + connection registry),
// server_options.go, server_fanout.go, server_heartbeat.go,
// server_frames.go, accept.go, subscribe.go, connection.go (ARCH-04).
type Server struct {
	path        string
