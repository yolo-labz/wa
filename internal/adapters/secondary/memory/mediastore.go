...
// is already cached, return Cached=true.
//
// Otherwise it mirrors the whatsmeow adapter's two-way split (issue #102,
// #312): an id this store has never seen is app.ErrMessageNotFound (-32117,
