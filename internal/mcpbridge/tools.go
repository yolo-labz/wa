...
func registerMessageSendTools(srv *mcp.Server, call Caller, cfg Config) {
	...
	mcp.AddTool(srv, &mcp.Tool{
		...
		Description: "Schedule a WhatsApp text message for a future time. Scheduled sends to known contacts are routed through the human-review draft queue at fire time.",
